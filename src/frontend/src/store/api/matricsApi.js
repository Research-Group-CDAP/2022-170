...
class MatricsAPI {
  ...
  static fetch_All_Memory_Utilization(userId) {
    return axios.get(`${BASE_URL}/memory/fetch/fetch_All_Memory_Utilization/${userId}`);
  }
  ...
  static fetch_All_Network_Utilization(userId) {
    return axios.get(`${BASE_URL}/network/fetch/fetch_All_Network_Utilization/${userId}`);
  }
  ...
  static fetch_Cpu_Usage_Promethues(userId) {
    return axios.post(
      `${BASE_URL}/prometheus/fetch/fetch_Cpu_Usage/${userId}`
    );
  }
