...
const generateYamlFile = async (req, res) => {
    ...
    } else if (req.params.experimentType === "All_the_applications_inthat_namespace_are_healthy") {
        All_the_applications_inthat_namespace_are_healthy.method[0].provider.arguments.name_pattern = req.params.podName
