...
router.get("/fetch/fetch_All_Predicted_Cpu_Usage_By_Pod", fetch_All_Predicted_Cpu_Usage_By_Pod);
router.get("/fetch/fetch_All_Predicted_Memory_Utilization_By_Pod", fetch_All_Predicted_Memory_Utilization_By_Pod);
router.get("/fetch/fetch_All_Predicted_Network_Utilization_By_Pod", fetch_All_Predicted_Network_Utilization_By_Pod);
